...
use rustpython_ast::{pyo3::ToPyo3Ast, pyo3_wrapper::ToPyo3Wrapper, Fold, source_code::SourceLocator};


#[pyfunction]
#[pyo3(signature = (source, filename="<unknown>", *, type_comments=false, locate=true))]
fn parse_wrap(source: &str, filename: &str, type_comments: bool, locate: bool, py: Python) -> PyResult<PyObject> {
...
#[pyfunction]
#[pyo3(signature = (source, filename="<unknown>", *, type_comments=false, locate=true))]
fn parse(source: &str, filename: &str, type_comments: bool, locate: bool, py: Python) -> PyResult<PyObject> {
